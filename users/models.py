...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    goal = models.CharField(
        ...
        null=True,
        blank=True,
        help_text=_("User's fitness goal")
    )
    ...
    height_unit = models.CharField(
        ...
        choices=[('cm', 'cm'), ('ft', 'ft')],
        default='cm',
        help_text=_("Unit for height (cm or ft)")
    )
    ...
    is_profile_complete = models.BooleanField(
        _('profile complete'),
        default=False,
        help_text=_("Designates whether the user has completed their profile/fitness info registration")
    )
